...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/Mr-Spade/clash/constant.Version=$(VERSION)" \
		-X "github.com/Mr-Spade/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
